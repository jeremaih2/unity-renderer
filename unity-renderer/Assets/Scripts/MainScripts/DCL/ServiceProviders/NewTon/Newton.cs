...
using System.Linq;
using DCL.Helpers.NFT.Markets.Newton_Internal;
using UnityEngine;

namespace DCL.Helpers.NFT.Markets
{
    public class Newton : INFTMarket
    {
        readonly MarketInfo newTonMarketInfo = new MarketInfo() { name = "newton" };
        ...
        private NFTInfo ResponseToNFTInfo(AssetResponse response)
        {
            ...
            ret.marketInfo = newTonMarketInfo;
        ...
        private string PriceToFloatingPointString(Newton_Internal.AssetSaleInfo saleInfo)
        {
        ...
        private string PriceToFloatingPointString(string price, Newton_Internal.PaymentTokenInfo tokenInfo)
        {
